    ...
    programs.helix = {
      ...
      themes = {
        "${config.scheme.slug}" = with config.scheme.withHashtag; {
          ...
          "ui.bufferline.active" = { fg = base06; bg = base02; underline = { color = base0C; style = "line"; }; modifiers = [ "italic" ]; };
          ...
          "markup.raw" = base07;
          "markup.raw.inline" = base07;
          "markup.raw.block" = base07;
        };
      };
    };
  };
