      ...
      curve = [
        ...
        }
        {
          _args = [
            ...
            { type = "bezier"; points = [ [0.38 1.21] [0.22 1] ]; }
          ];
        }
        {
          _args = [
        ...
        }
        {
          _args = [
            "standardDecel"
            { type = "bezier"; points = [ [0 0] [0 1] ]; }
          ];
        }
        {
          _args = [
            "menu_decel"
            { type = "bezier"; points = [ [0.1 1] [0 1] ]; }
          ];
        }
        {
          _args = [
        ...
        }
        {
          _args = [
            "stall"
            { type = "bezier"; points = [ [1 (-0.1)] [0.7 0.85] ]; }
          ];
        }
      ];
      animation = [
        ...
        {
          _args = [
            { leaf = "zoomFactor"; enabled = true; speed = 3; bezier = "standardDecel"; }
          ];
        }
      ];
    };   
