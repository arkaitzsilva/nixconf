{
  flake.modules.homeManager.dev = { config, ... }: {
    programs.zed-editor = {
      userSettings.theme = config.scheme.scheme-name;
      themes = {
        "${config.scheme.scheme-name}" = with config.scheme.withHashtag; {
          ...
          themes = [
            {
              ...
              style = {
                ...
                "terminal.foreground" = "${base04}ff";
                "terminal.bright_foreground" = "${base06}ff";
                "terminal.dim_foreground" = "${base03}ff";
                "terminal.ansi.black" = "${base01}ff";
                ...
                "terminal.ansi.bright_white" = "${base06}ff";
                "terminal.ansi.dim_white" = "${base04}ff";
                "link_text.hover" = "${base0C}ff";
